  ...
  <section id="contact" className="py-20 bg-charcoal-blue scroll-mt-20">
    <div className="max-w-6xl mx-auto px-4 sm:px-8">
      <div className="text-center mb-16">
        ...
        <p className="text-body text-cream-beige max-w-xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-col gap-10 sm:gap-5">
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              ...
              <a
                href="tel:0501105765"
                className="text-off-white hover:text-cream-beige text-description transition font-medium"
              >
                0501105765
              </a>
            </div>
        ...
        <div>
          <form className="flex flex-col gap-6">
            <input
              ...
              className="w-full px-5 py-4 bg-off-white rounded-lg border border-cream-beige focus:outline-none focus:ring-3 focus:ring-cream-beige text-description placeholder-dark-gray/50 transition text-black"
            />
            <input
              type="email"
              placeholder="Your Email"
              className="w-full px-5 py-4 bg-off-white rounded-lg border border-cream-beige focus:outline-none focus:ring-3 focus:ring-cream-beige text-description placeholder-dark-gray/50 text-black transition"
            />
            <input
              type="text"
              placeholder="Subject"
            ...
            <textarea
              ...
              rows={5}
              className="w-full px-5 py-4 bg-off-white rounded-lg border border-cream-beige focus:outline-none focus:ring-3 focus:ring-cream-beige text-description placeholder-dark-gray/50 text-black transition resize-none"
            ></textarea>
            <button
              type="submit"
