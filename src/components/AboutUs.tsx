...
const MissionSection = () => (
  <section
    className="w-full min-h-[320px] bg-white flex flex-row scroll-mt-20 color-change text-black"
    id="about"
  >
    {/* Left Text */}
    <div className="flex-1 flex items-center justify-center px-8 py-16">
      <div className="max-w-md">
        ...
        <p className="text-small sm:text-description text-black/80 graytext max-w-2xl leading-relaxed font-medium">
