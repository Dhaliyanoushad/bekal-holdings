          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-blue-50 p-8 rounded-lg">
              ...
              <p className="text-gray-700">
                To become a leading global conglomerate by building and
                acquiring reputed brands across diverse industries. We strive to
                deliver innovative solutions, exceptional customer experiences,
                and high-quality services, while actively seeking strategic
                investment opportunities to drive sustainable growth and expand
                our market presence.
              </p>
            </div>
            <div className="bg-blue-50 p-8 rounded-lg">
