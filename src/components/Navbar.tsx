    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <button
            className="ml-6 px-5 py-2 bg-[#ea580c] hover:bg-[#c2410c] text-[#faf6ee] rounded-sm text-sm font-medium transition-colors duration-200"
          >
            Contact
          </button>
        </div>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-4 pb-6 pt-2 border-t border-[#005c4d]/30">
              ...
              <button
                className="mt-4 w-full px-4 py-3 bg-[#ea580c] hover:bg-[#c2410c] text-[#faf6ee] rounded-sm text-sm font-medium transition-colors"
              >
                Contact
              </button>
            </div>
