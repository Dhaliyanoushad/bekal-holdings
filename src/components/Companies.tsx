...
const Companies = () => (
  <section
    id="companies"
    className="py-20 bg-white relative scroll-mt-20 color-change text-black"
  >
    <div className="max-w-7xl mx-auto px-4 sm:px-8">
      <div className="text-center mb-16">
        <h2 className="text-heading-sm sm:text-heading font-bold mb-4 tracking-tight">
          Our Portfolio Companies
        </h2>
        <div className="w-20 h-1 bg-primary-orange mx-auto mb-8 rounded-full" />
        <p className="text-description sm:text-body text-black/80 graytext max-w-2xl mx-auto leading-relaxed">
        ...
        {companies.map((company, idx) => (
          ...
          >
            <div className="flex flex-col gap-0 sm:gap-3">
              ...
              <h3 className="text-xl md:text-subheading font-semibold mb-2">
                {company.title}
              </h3>
              <p className="text-description text-black/80 graytext font-medium leading-relaxed">
                {company.desc}
              </p>
            </div>
          </div>
